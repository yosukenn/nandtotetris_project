...
public class VMtranslator {
    ...
    public static void main(String[] args) {
        ...
        // 一旦コマンドライン引数では.vmファイルを受け取る実装をする
        // コマンドライン引数　/Users/yosukennturner/Desktop/nand2tetris/projects/07/StackArithmetic/StackTest/StackTest.vm
        ...
        try {
            try (Parser parser = new Parser(args[0])) {
                ...
                try (CodeWriter codeWriter = new CodeWriter(args[0].substring(0, lastSlashIndex) + "/" + fileNameMaterial + ".asm")) {
